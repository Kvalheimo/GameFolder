...
import blog.boomerangbeast.GameContactListener;
...
import blog.boomerangbeast.entity.components.CheckpointComponent;
import blog.boomerangbeast.entity.components.CollisionComponent;
import blog.boomerangbeast.entity.components.DestroyableTileComponent;
import blog.boomerangbeast.entity.components.EnemyComponent;
import blog.boomerangbeast.entity.components.JumpWallComponent;
...
public class LevelFactory {
    ...
    public LevelFactory(PooledEngine engine, BoomerangBeast parent, int level){
        this.engine = engine;
        this.parent = parent;
        this.level = level;

        world = new World(new Vector2(0,-BoomerangBeast.GRAVITY), true);
    ...
    private void loadParticleEffects(){
        ...
        peMan.addParticleEffect(ParticleEffectManager.SMOKE, parent.assMan.manager.get("particles/smoke.p",ParticleEffect.class),1f/ BoomerangBeast.PPM);
        peMan.addParticleEffect(ParticleEffectManager.EXPLOSION, parent.assMan.manager.get("particles/explosion.p", ParticleEffect.class),1f/ BoomerangBeast.PPM);
        peMan.addParticleEffect(ParticleEffectManager.BLOOD, parent.assMan.manager.get("particles/blood.p",ParticleEffect.class),1f/ BoomerangBeast.PPM);
        peMan.addParticleEffect(ParticleEffectManager.SPLASH, parent.assMan.manager.get("particles/splash.p",ParticleEffect.class),1f/ BoomerangBeast.PPM);
        peMan.addParticleEffect(ParticleEffectManager.SPEED, parent.assMan.manager.get("particles/speed.p",ParticleEffect.class),1f/ BoomerangBeast.PPM);
        peMan.addParticleEffect(ParticleEffectManager.POWER_UP, parent.assMan.manager.get("particles/powerup.p",ParticleEffect.class),1f/ BoomerangBeast.PPM);
        peMan.addParticleEffect(ParticleEffectManager.TEST, parent.assMan.manager.get("particles/test.p",ParticleEffect.class),1f/ BoomerangBeast.PPM);

        peMan.addParticleEffect(ParticleEffectManager.BULLET_RIGHT, parent.assMan.manager.get("particles/bullet_right.p",ParticleEffect.class),1f/ BoomerangBeast.PPM);
        peMan.addParticleEffect(ParticleEffectManager.BULLET_LEFT, parent.assMan.manager.get("particles/bullet_left.p",ParticleEffect.class),1f/ BoomerangBeast.PPM);

        peMan.addParticleEffect(ParticleEffectManager.SUPERSPEED_RIGHT, parent.assMan.manager.get("particles/superspeed_right.p",ParticleEffect.class),1f/ BoomerangBeast.PPM);
        peMan.addParticleEffect(ParticleEffectManager.SUPERSPEED_LEFT, parent.assMan.manager.get("particles/superspeed_left.p",ParticleEffect.class),1f/ BoomerangBeast.PPM);
        peMan.addParticleEffect(ParticleEffectManager.POWERUP_SPEED, parent.assMan.manager.get("particles/powerup_speed.p",ParticleEffect.class),1f/ BoomerangBeast.PPM);
        peMan.addParticleEffect(ParticleEffectManager.POWERUP_GUN, parent.assMan.manager.get("particles/powerup_gun.p",ParticleEffect.class),1f/ BoomerangBeast.PPM);
    ...
    public Entity createPlayer(OrthographicCamera camera, int character){
        ...
        switch (level){
            case 1:
                bodyCom.body = bodyFactory.makeCirclePolyBody(6, 10, 0.20f, BodyFactory.WOOD, BodyDef.BodyType.DynamicBody, true);
                break;
            case 2:
                bodyCom.body = bodyFactory.makeCirclePolyBody(3, 12, 0.20f, BodyFactory.WOOD, BodyDef.BodyType.DynamicBody, true);
                break;
            case 3:
        ...
        position.position.set(bodyCom.body.getPosition().x/ BoomerangBeast.PPM, bodyCom.body.getPosition().y/ BoomerangBeast.PPM,0);
...
//        entity.add(bodyCom);
    ...
    public void removeGunTile(Body body){
        ...
        //Remove part 1
       layer.getCell((int)Math.floor(body.getPosition().x * BoomerangBeast.PPM / 16f),
              (int)Math.floor(body.getPosition().y * BoomerangBeast.PPM / 16f)).setTile(null);


       //Remove part 2
        layer.getCell((int)(body.getPosition().x * BoomerangBeast.PPM / 16f),
               (int)((body.getPosition().y * BoomerangBeast.PPM / 16f)-1)).setTile(null);

        //Remove part 3
        layer.getCell((int)Math.floor((body.getPosition().x * BoomerangBeast.PPM / 16f)-1),
             (int)Math.floor(body.getPosition().y * BoomerangBeast.PPM / 16f)-1).setTile(null);
    ...
    public void removeSuperSpeedTile(Body body){
        ...
        //Remove part 1
        layer.getCell((int)(body.getPosition().x * BoomerangBeast.PPM / 16f),
              (int)(body.getPosition().y * BoomerangBeast.PPM / 16f)).setTile(null);
        ...
        //Remove part 3
        layer.getCell((int)((body.getPosition().x * BoomerangBeast.PPM / 16f)-1),
                (int)((body.getPosition().y * BoomerangBeast.PPM / 16f)-1)).setTile(null);
